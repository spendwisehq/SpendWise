...
import {
  ...
  ArrowDownRight, Plus, RefreshCw, Calendar,
} from 'lucide-react';
...
const CATEGORY_COLORS = [
  '#1D9E75', '#E85D24', '#378ADD', '#EF9F27',
  '#7F77DD', '#D4537E', '#3B6D11', '#993556',
];

// ── Stat Card ────────────────────────────────
const StatCard = ({ title, value, icon: Icon, trend, trendLabel, color, loading }) => (
    ...
    <div className="dashboard">
      ...
      <div className="stats-grid">
        <StatCard
          ...
          value={fmt(thisMonth.totalExpense || 0, currency)}
          icon={TrendingDown}
        ...
        <StatCard
          title="Total Income"
          value={fmt(thisMonth.totalIncome || 0, currency)}
          icon={TrendingUp}
        ...
        <StatCard
          title="Net Savings"
          value={fmt(thisMonth.netSavings || 0, currency)}
          icon={Wallet}
        ...
        <StatCard
          title="Transactions"
          value={thisMonth.transactionCount || 0}
          icon={ArrowUpRight}
      ...
      <div className="charts-grid">
        ...
        <div className="chart-card">
          <div className="chart-card__header">
            <h3 className="chart-card__title">By Category</h3>
          </div>
          {loading ? (
            <div className="skeleton skeleton--chart" />
          ) : pieData.length === 0 ? (
      ...
      <div className="bottom-grid">
        ...
        <div className="card">
          <div className="card__header">
            ...
            <a href="/transactions" className="card__link">View all</a>
          </div>
          {loading ? (
            ...
            <div className="empty-state">
              ...
              <a href="/transactions" className="btn btn--primary btn--sm">Add your first</a>
            </div>
          ) : (
              ...
              {recent.map(txn => (
                <div key={txn._id} className="txn-item">
                  <div className="txn-item__icon" style={{
                    background: txn.type === 'income' ? '#E1F5EE' : '#FEF0EB',
        ...
        <div className="card">
          ...
          {loading ? (
            Array(4).fill(0).map((_, i) => <div key={i} className="skeleton skeleton--row" />)
          ) : (
