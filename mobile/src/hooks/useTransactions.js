// mobile/src/hooks/useTransactions.js
...
export function useCreateTransaction() {
  ...
  return useMutation({
    ...
    onError: (err, _, context) => {
      ...
      Toast.show({ type: 'error', text1: err.message || 'Failed to add transaction' });
    },
    onSuccess: () => {
...
export function useUpdateTransaction() {
  ...
  return useMutation({
    ...
    onError: (err, _, context) => {
      ...
      Toast.show({ type: 'error', text1: err.message || 'Failed to update transaction' });
    },
    onSuccess: () => {
...
export function useDeleteTransaction() {
  ...
  return useMutation({
    ...
    onError: (err, _, context) => {
      ...
      Toast.show({ type: 'error', text1: err.message || 'Failed to delete transaction' });
    },
    onSuccess: () => {
